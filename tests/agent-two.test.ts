    ...
    expect(resp).toMatchInlineSnapshot(`
      Object {
        ...
        "metadata": Object {
          ...
          "image": "https://wrappedpunks.com:3000/images/punks/1.png",
          "name": "W#1",
          "title": "W#1",
        },
        "name": "W#1",
  ...
  it(`should be able to fetch and parse metadata for Blitmap ${BLITMAP_TOKEN_ADDRESS}`, async () => {
    ...
    expect(resp).toMatchInlineSnapshot(`
      Object {
        ...
        "contentURLMimeType": "image/png",
        "description": "Please note that Blitnaut redemption status on OpenSea is only intended as a convenience and **may be delayed**. If you're looking for a Blitmap to craft a Blitnaut, always check eligibility [from the site](https://blitnauts.blitmap.com/check_blitmap) before you move forward.
  ...
  it(`should be able to fetch and parse metadata for Solvency ${SOLVENCY_TOKEN_ADDRESS}`, async () => {
    ...
    expect(resp).toMatchInlineSnapshot(`
      Object {
        ...
        "imageURLMimeType": "application/octet-stream",
        "metadata": Object {
